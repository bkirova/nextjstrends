				...
				<li class="my-px">
					<a href="/top"
					   class="flex flex-row items-center h-20 text-gray-500">
						...
						<span class="ml-3 font-medium font-bold text-sm text-gray-900 uppercase animate-pulse">Today's Top</span>
					</a>
				</li>
                ...
                <li class="my-px">
					<a href="/trends"
					   class="flex flex-row items-center h-20 text-gray-500">
						...
						<span class="ml-3 font-medium text-sm text-gray-400 uppercase">Trends</span>
					</a>
				</li>

            ...
            <div className="mt-10 mb-10 flex items-center justify-center">
                ...
                >
                    ...
                    <div className="upload__image-wrapper ">
                        ...
                        onClick={onImageUpload} {...dragProps} className={`${isDragDropVisible ? 'flex' : 'hidden'} p-20 h-80 w-full lg:max-w-xl text-center flex flex-col items-center justify-center items-center hover:bg-gray-100 rounded-lg border-4 border-dashed group text-center`}>

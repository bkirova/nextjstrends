...
let items = [
    {category: 'NEWS', title: 'DogeCoin to the moon', text: 'Dogecoin is a cryptocurrency created by software engineers Billy Markus and Jackson Palmer, who decided to create a payment system as a joke.'},
    {category: 'DEVELOPING', title: 'Next.js the next js framework', text: 'Next.js is an open-source React front-end development web framework created by Vercel that enables functionality such as server-side rendering.'},
